// src/main.js
/**
 * Main entry point for ModernNftService application
 */
...
class ModernNftService {
    /**
     * Create a new ModernNftService instance
...
module.exports = ModernNftService;
...
if (require.main === module) {
    ...
    const app = new ModernNftService({
        input: args.input,
        output: args.output,
